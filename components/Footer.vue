                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 mt-40">
                        <div class="widget-item">
                            <div class="about-widget">
                                ...
                                <p>The place where we thrive to provide the best as possible and nurture these children's future. You can too.</p>
                                <div class="widget-total-raised">
                                    <h4 class="raised-title">Total Children Raised:</h4>
